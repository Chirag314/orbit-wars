...
class ProducerLiteConfig:
    ...
    min_ships_to_launch: float = 12.0
    max_drain_fraction: float = 1.0
    # Reinforcement risk
...
def plan_lite_waves(
    *,
    ...
    if float(config.max_drain_fraction) < 1.0:
        drain = (drain * float(config.max_drain_fraction)).floor().clamp(min=0.0)
...
CONFIG_4P = replace(
    ...
    max_drain_fraction=0.65,
    min_ships_to_launch=15.0,
)
